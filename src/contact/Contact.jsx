...
function contact() {
  return (
    <div>
        <PageHeader title={"Get In Touch With US"} curPage={"Contac US"}/>
        <div className='map-address-sectio padding-tb section-bg'>
                            ...
                            <div className='setion-wrapper'>
                                      <form className='contact-form'>
                                            ...
                                            <div className='form-group w-100'>
                                                <textarea name="message" id="message"rows="8" placeholder='Your Message'>
                                                    </textarea>           
                                            </div>
