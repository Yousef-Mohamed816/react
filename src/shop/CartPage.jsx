...
const CartPage = () => {
    ...
    useEffect(() =>{
        const staredCartItems  = JSON.parse(localStorage.getItem("cart")) || [];
        setcartItems(staredCartItems);
    }, [])
    ...
    const handleRemoveItem = (item) =>  {
        ...
        updeteLoclStorage(updatedCart)
        
    }
  

    const updeteLoclStorage = (cart) => {
                                                ...
                                                <div className='calculate-shiping'>
                                                    ...
                                                    <select>
                                                        <option value="uk">New York</option>
                                                            ...
                                                            <option value="np">Dhilh</option>
                                                        </select>
                                                        <span className='select-icon'>
                                                             <i className='icofont-rounded-down'></i>
                                                        </span>
                                                    </div>
                                                    <input type="text" name="postalCode" id="PostalCode" placeholder='Postocde/ZIp +' className='cart-page-input-text' />
                                            ...
                                            <div className='col-md-6 col-12'>
                                                <div className='cart-overview'>
                                                    ...
                                                    <ul className='lab-ul'>
                                                        ...
                                                        <li>
                                                            <span className='pull-left'>Drder Total</span>
